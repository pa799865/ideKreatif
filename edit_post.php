                    ...
                    <form method="POST" action="proses_post.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($post['image_path'])): ?>
                                <div class="mt-2">
                                    <img src="<?php echo $post['image_path']; ?>" alt="Current Image" class="img-thumbnail" style="max-width=200px;">
                                </div>
                                <?php endif; ?>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="content" id="content" required><?php echo $post['content']; ?></textarea>
                        </div>
